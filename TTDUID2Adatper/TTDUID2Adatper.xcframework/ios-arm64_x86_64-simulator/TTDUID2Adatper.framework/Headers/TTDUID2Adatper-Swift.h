...
#ifndef TTDUID2ADATPER_SWIFT_H
#define TTDUID2ADATPER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TTDUID2Adatper",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14TTDUID2Adatper14TTDUID2Manager")
...
- (void)clear;
- (void)startWithTestMode:(BOOL)testMode completionHandler:(void (^ _Nonnull)(NSError * _Nullable))completionHandler;
